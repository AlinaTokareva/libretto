...
export namespace Prisma {
  ...
  */
  ...
  export type WishOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "completed" | "createdAt" | "updatedAt", ExtArgs["result"]["wish"]>
  ...
  interface WishFieldRefs {
    ...
    readonly completed: FieldRef<"Wish", 'Boolean'>
  ...
  export type WishWhereInput = {
    ...
    name?: StringNullableFilter<"Wish"> | string | null
    completed?: BoolFilter<"Wish"> | boolean
  ...
  export type WishScalarWhereWithAggregatesInput = {
    ...
    name?: StringNullableWithAggregatesFilter<"Wish"> | string | null
    completed?: BoolWithAggregatesFilter<"Wish"> | boolean
